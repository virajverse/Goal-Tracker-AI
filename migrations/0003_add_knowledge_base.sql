...
VALUES 
    (uuid_generate_v5(uuid_nil(), 'category_faq'), 'FAQ', 'Frequently asked questions', 'help-circle', 1),
    (uuid_generate_v5(uuid_nil(), 'category_questions'), 'Questions', 'Common questions and answers', 'message-square', 2)
